...
#ifndef NAKEN_ASM_SIMULATE_RV32EM_H
#define NAKEN_ASM_SIMULATE_RV32EM_H

#include <unistd.h>

#include "simulate/Simulate.h"

class SimulateRv32em : public Simulate
{
public:
  SimulateRv32em(Memory *memory);
  virtual ~SimulateRv32em();
